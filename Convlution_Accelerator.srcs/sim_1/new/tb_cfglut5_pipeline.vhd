-- Six-stage (window distribution + five arithmetic) CE/valid alignment.
library ieee;
...
begin
    ...
    monitor : process
        variable valids : std_logic_vector(5 downto 0) := (others => '0');
    ...
    begin
        ...
        elsif enabled then valids := valids(4 downto 0) & vin;
        end if;
        wait for 1 ns;
        assert vout = valids(5)
            report "Six-stage CE-relative valid latency mismatch" severity failure;
    ...
    begin
        ...
        report "PIPELINE_125_PASS shifts=32 bias_cases=16 relu_modes=2 outputs=" & integer'image(received);
        stop(0);
        wait;
    end process;
